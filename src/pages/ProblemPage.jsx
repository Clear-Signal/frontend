    ...
    >
      ...
      <ul className="max-h-80 rounded-b-lg bg-zinc-800 overflow-y-auto">
        {loading ? (
          ...
          <li className="p-4 text-center text-gray-400">No submissions found.</li>
        ) : (
          submissions.map((sub) => (
            <li
              key={sub._id}
                ...
                <div className="flex items-center justify-between bg-[#1e1e1e] border border-zinc-800 rounded-xl px-3 py-1">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      aria-label="Back"
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="stroke-current text-gray-300">
                  ...
                  {/* right - tiny icons */}
                  <div className="flex items-center gap-2">
                    <button className="p-2 rounded-md hover:bg-zinc-800 text-gray-400" title="Toggle mute">
            ...
            <div className={`rounded-lg border border-zinc-800 bg-[#09090B] flex flex-col h-full overflow-hidden ${isEditorFullscreen ? "fixed py-4 px-6 inset-0 z-50 !h-screen !rounded-none" : ""}`}>
              ...
              <div className="relative flex items-center justify-between m-2 p-2 flex-shrink-0">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {/* zoom out */}
                  <button onClick={zoomOut} className="w-8 h-8 rounded-md border-1 border-zinc-800 hover:bg-zinc-800 flex items-center justify-center cursor-pointer" title="Zoom out">
                    <FiMinus />
                  </button>

                  {/* zoom in */}
                  <button onClick={zoomIn} className="w-8 h-8 rounded-md border-1 border-zinc-800 hover:bg-zinc-800 flex items-center justify-center cursor-pointer" title="Zoom in">
                    <FiPlus />
                  </button>
                    ...
                    {isShortcutsOpen && (
                      ...
                      >
                        <div className="p-3 border-b border-zinc-800">
                          <div className="flex items-center justify-between">
                            <h4 className="text-sm font-semibold text-white">Editor Shortcuts</h4>
                            <button
                        ...
                        <div className="p-3 text-sm text-gray-300 space-y-2">
                          <div className="flex justify-between">
                            ...
                            <div className="text-xs text-gray-400">Ctrl / ⌘ + Shift + P</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Quick Open</div>
                          ...
                          <div className="flex justify-between">
                            <div>Find</div>
                            <div className="text-xs text-gray-400">Ctrl / ⌘ + F</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Replace</div>
                            <div className="text-xs text-gray-400">Ctrl / ⌘ + H</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Go to Line</div>
                            <div className="text-xs text-gray-400">Ctrl / ⌘ + G</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Toggle Comment</div>
                            <div className="text-xs text-gray-400">Ctrl / ⌘ + /</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Format Document</div>
                            <div className="text-xs text-gray-400">Shift + Alt + F</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Trigger Suggest</div>
                            <div className="text-xs text-gray-400">Ctrl / ⌘ + Space</div>
                          </div>
                          <div className="flex justify-between">
                            <div>Run Code (UI)</div>
                            <div className="text-xs text-gray-400">Run button</div>
                          </div>
                        </div>
                      </motion.div>
                    )}
                  ...
                  {/* fullscreen toggle */}
                  <button onClick={() => setIsEditorFullscreen((f) => !f)} className="w-8 h-8 rounded-md border-1 border-zinc-800 hover:bg-zinc-800 flex items-center justify-center cursor-pointer">
              ...
              <PanelGroup direction="vertical" className="flex-grow">
                <Panel defaultSize={60} minSize={20} className="mx-5 my-2 rounded-xl">
                  <Editor
                    height="100%"
                    language={lang}
                    value={code}
